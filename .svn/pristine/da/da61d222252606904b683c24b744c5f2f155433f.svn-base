        ...
        <div class="span12">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                        ...
                        echo form_dropdown('user_type_id', $dropdown_user_type_id, 
                                ...
                                'class="validate[funcCall[validateDropdownRequired]] input-xlarge " id="user_type_id" tabindex="2"' );
                    ?>
                </div>
            </div>             
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[100]] input-xlarge " id="unique_key" tabindex="3" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo form_input('is_admin',  
                        set_value('is_admin', object_element('is_admin', $row)), 
                        'class="validate[custom[integer]] input-xlarge  input-integer" id="is_admin" tabindex="4" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[20]] input-xlarge " id="username" tabindex="5" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[50]] input-xlarge " id="name_prefix" tabindex="6" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[30]] input-xlarge " id="last_name" tabindex="8" '); ?>
                    </div>
                </div>                
                    
                <div class="control-group">
                    <label class="control-label form-lbl" for="full_name"><?php _e('Full Name') ?></label>
                    <div class="controls">
                        <?php echo form_input('full_name',  
                        set_value('full_name', object_element('full_name', $row)), 
                        'class="validate[maxSize[60]] input-xlarge " id="full_name" tabindex="9" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[100]] input-xlarge " id="email" tabindex="10" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[255]] input-xlarge " id="website" tabindex="11" '); ?>
                    </div>
                </div>                
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                        ...
                        echo form_dropdown('company_id', $dropdown_company_id, 
                                ...
                                'class="validate[] input-xlarge " id="company_id" tabindex="12"' );
                    ?>
                </div>
            </div>             
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[50]] input-xlarge " id="home_phone" tabindex="13" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[50]] input-xlarge " id="work_phone" tabindex="14" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[50]] input-xlarge " id="day_phone" tabindex="15" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[50]] input-xlarge " id="evening_phone" tabindex="16" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[50]] input-xlarge " id="mobile" tabindex="17" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[50]] input-xlarge " id="fax" tabindex="18" '); ?>
                    </div>
                </div>                
            ...
            <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[10]] input-xlarge " id="gender" tabindex="20" '); ?>
                    </div>
                </div>                
                ...
                <div class="controls">
                    <?php
                        ...
                        echo form_dropdown('country_id', $dropdown_country_id, 
                                ...
                                'class="validate[] input-xlarge " id="country_id" tabindex="21"' );
                    ?>
                </div>
            </div> 
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                        ...
                        echo form_dropdown('state_id', $dropdown_state_id, 
                                ...
                                'class="validate[] input-xlarge " id="state_id" tabindex="22"' );
                    ?>
                </div>
            </div> 
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                        ...
                        echo form_dropdown('city_id', $dropdown_city_id, 
                                ...
                                'class="validate[] input-xlarge " id="city_id" tabindex="23"' );
                    ?>
                </div>
            </div> 
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                        ...
                        echo form_dropdown('zip_code_id', $dropdown_zip_code_id, 
                                ...
                                'class="validate[] input-xlarge " id="zip_code_id" tabindex="24"' );
                    ?>
                </div>
            </div> 
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                        ...
                        echo form_dropdown('attorney_id', $dropdown_attorney_id, 
                                ...
                                'class="validate[] input-xlarge " id="attorney_id" tabindex="25"' );
                    ?>
                </div>
            </div>             
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[funcCall[validateDateTime]] input-xlarge  datetime" id="date_of_record" tabindex="26" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[100]] input-xlarge " id="referred_by" tabindex="27" '); ?>
                    </div>
                </div>                
                ...
                <div class="controls">
                    <?php
                        ...
                        echo form_dropdown('inserter_id', $dropdown_inserter_id, 
                                ...
                                'class="validate[] input-xlarge " id="inserter_id" tabindex="29"' );
                    ?>
                </div>
            </div>             
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[funcCall[validateDateTime]] input-xlarge  datetime" id="insert_date" tabindex="30" '); ?>
                    </div>
                </div>                
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                        ...
                        echo form_dropdown('updater_id', $dropdown_updater_id, 
                                ...
                                'class="validate[] input-xlarge " id="updater_id" tabindex="31"' );
                    ?>
                </div>
            </div>             
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[funcCall[validateDateTime]] input-xlarge  datetime" id="update_date" tabindex="32" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[custom[number]] input-xlarge  input-number" id="height" tabindex="33" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[custom[number]] input-xlarge  input-number" id="weight" tabindex="34" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[20]] input-xlarge " id="hair_color" tabindex="35" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[20]] input-xlarge " id="eye_color" tabindex="36" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[funcCall[validateDateTime]] input-xlarge  datetime" id="date_of_birth" tabindex="37" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo form_input('birth_country',  
                        set_value('birth_country', object_element('birth_country', $row)), 
                        'class="validate[maxSize[100]] input-xlarge " id="birth_country" tabindex="38" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo form_input('birth_state',  
                        set_value('birth_state', object_element('birth_state', $row)), 
                        'class="validate[maxSize[100]] input-xlarge " id="birth_state" tabindex="39" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo form_input('birth_city',  
                        set_value('birth_city', object_element('birth_city', $row)), 
                        'class="validate[maxSize[100]] input-xlarge " id="birth_city" tabindex="40" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[100]] input-xlarge " id="nationality" tabindex="41" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[100]] input-xlarge " id="race" tabindex="42" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[9]] input-xlarge " id="ssn" tabindex="43" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[100]] input-xlarge " id="passport" tabindex="44" '); ?>
                    </div>
                </div>                
                ...
                <div class="controls">
                    <?php
                        ...
                        echo form_dropdown('passport_country_id', $dropdown_passport_country_id, 
                                ...
                                'class="validate[] input-xlarge " id="passport_country_id" tabindex="45"' );
                    ?>
                </div>
            </div>             
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[funcCall[validateDateTime]] input-xlarge  datetime" id="date_passport_expires" tabindex="46" '); ?>
                    </div>
                </div>                
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                        ...
                        echo form_dropdown('marital_status_id', $dropdown_marital_status_id, 
                                ...
                                'class="validate[] input-xlarge " id="marital_status_id" tabindex="47"' );
                    ?>
                </div>
            </div>             
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[custom[integer]] input-xlarge  input-integer" id="previous_marriages_count" tabindex="48" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[funcCall[validateDateTime]] input-xlarge  datetime" id="date_married" tabindex="49" '); ?>
                    </div>
                </div>                
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        'class="validate[maxSize[100]] input-xlarge " id="place_married" tabindex="50" '); ?>
                    </div>
                </div>                
