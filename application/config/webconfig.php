...
$config['default_thumb'] = 'upload/default/default.png';

#Yorum ayarları
$config['kademeli_yorum_sayisi'] = 1;
$config['yorum_avatar'] = $config['theme_path'].'/css/images/avatar.png';
...
$config['is_authorization_active'] = FALSE;
