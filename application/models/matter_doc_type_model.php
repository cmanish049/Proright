...
class Matter_doc_type_model extends MY_Model
{ 
    
    
    public function __construct()
    {
        parent::__construct('matter_doc_types', 'doc_type_id');
    ...
    public function callback_search(&$extra=array())
    {
        ...
        $search_fields = array_map('trim', explode(',', self::column_name('doc_type_name')));
