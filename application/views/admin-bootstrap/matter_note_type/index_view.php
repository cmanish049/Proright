                ...
                <div class="box-content">
                    <div class="section-padding">
                        <div class="grid-container">
                            <div id="matter_note_typeGrid"></div>
                        </div>
                    </div>
                </div>
...
<script type="text/x-kendo-template" id="matter_note_type-quickview-template">
    <div id="quickview-container">
        <table class="quickview-grid">
            ...
            <tbody>  
            	...
            	<tr>
                    <td><strong><?php _e('Note Type Name'); ?></strong></td>
...
<script type="text/javascript">
    var matter_note_typeGrid;
    
    $(function() {
        grid(
            $('#matter_note_typeGrid'),
            {
                ...
                model : {
                    ...
                    fields: {
                        actions:{},
                        note_type_name: { type: 'string' },
                        is_active: { type: 'number' }
                    }
                },
                gridOptions : {
                    toolbar: [{template:$('#matter_note_type-toolbar-template').html()}],
                    columns: [
                        {
                            title:'<?php _e('Actions') ?>',
                            template: $('#matter_note_type-actions-template').html(),
                            filterable:false,
                            groupable:false,
                            sortable:false,
                            width:150,
        ...
        matter_note_typeGrid = $('#matter_note_typeGrid').data('kendoGrid');
