                ...
                <div class="box-content">
                    <div class="section-top-padding">
                        ...
                        <div class="control-group">
                            <label class="control-label form-lbl" for="exhibit_type_name"><?php _e('Exhibit Type Name') ?></label>
                            <div class="controls">
                                <?php
                                echo form_input('exhibit_type_name', set_value('exhibit_type_name', object_element('exhibit_type_name', $row)), 'class="validate[required,maxSize[255]] input-xlarge " id="exhibit_type_name" tabindex="2" ');
                                ?>
                            </div>
                        </div>                
