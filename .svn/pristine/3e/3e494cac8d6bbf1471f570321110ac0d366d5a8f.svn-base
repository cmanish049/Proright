...
class Event_priority_model extends MY_Model
{ 
    
    
    public function __construct()
    {
        parent::__construct('event_priorities', 'priority_id');
    ...
    public function callback_search(&$extra=array())
    {
        ...
        $search_fields = array_map('trim', explode(',', self::column_name('priority_name')));
