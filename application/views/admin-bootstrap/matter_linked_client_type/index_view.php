                ...
                <div class="box-content">
                    <div class="section-padding">
                        <div class="grid-container">
                            <div id="matter_linked_client_typeGrid"></div>
                        </div>
                    </div>
                </div>
...
<script type="text/x-kendo-template" id="matter_linked_client_type-quickview-template">
    <div id="quickview-container">
        <table class="quickview-grid">
            ...
            <tbody>  
            	...
            	<tr>
                    <td><strong><?php _e('Linked Type Name'); ?></strong></td>
...
<script type="text/javascript">
    var matter_linked_client_typeGrid;
    
    $(function() {
        grid(
            $('#matter_linked_client_typeGrid'),
            {
                ...
                model : {
                    ...
                    fields: {
                        actions:{},
                        linked_type_name: { type: 'string' },
                        is_active: { type: 'number' }
                    }
                },
                gridOptions : {
                    toolbar: [{template:$('#matter_linked_client_type-toolbar-template').html()}],
                    columns: [
                        {
                            title:'<?php _e('Actions') ?>',
                            template: $('#matter_linked_client_type-actions-template').html(),
                            filterable:false,
                            groupable:false,
                            sortable:false,
                            width:150,
        ...
        matter_linked_client_typeGrid = $('#matter_linked_client_typeGrid').data('kendoGrid');
