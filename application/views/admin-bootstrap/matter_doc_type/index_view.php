                ...
                <div class="box-content">
                    <div class="section-padding">
                        <div class="grid-container">
                            <div id="matter_doc_typeGrid"></div>
                        </div>
                    </div>
                </div>
...
<script type="text/x-kendo-template" id="matter_doc_type-quickview-template">
    <div id="quickview-container">
        <table class="quickview-grid">
            ...
            <tbody>  
            	...
            	<tr>
                    <td><strong><?php _e('Doc Type Name'); ?></strong></td>
                    <td><?php echo kendouiDataItemTemplateString('doc_type_name'); ?></td>
             	</tr>
    ...
    $(function() {
        grid(
            $('#matter_doc_typeGrid'),
            {
                ...
                gridOptions : {
                    toolbar: [{template:$('#matter_doc_type-toolbar-template').html()}],
                    columns: [
                        {
                            title:'<?php _e('Actions') ?>',
                            template: $('#matter_doc_type-actions-template').html(),
                            filterable:false,
                            groupable:false,
                            sortable:false,
                            width:150,
        ...
        matter_doc_typeGrid = $('#matter_doc_typeGrid').data('kendoGrid');
