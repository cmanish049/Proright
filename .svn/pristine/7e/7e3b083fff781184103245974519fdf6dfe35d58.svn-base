<div class="form-container">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php
            echo form_input('state_name', set_value('state_name', object_element('state_name', $row)), 'class="validate[required,maxSize[255]] input-xlarge " id="state_name" tabindex="2" ');
            ?>
        </div>
    </div>                
