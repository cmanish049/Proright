...
class Matter_note_type_model extends MY_Model
{ 
    
    
    public function __construct()
    {
        parent::__construct('matter_note_types', 'note_type_id');
    ...
    public function callback_search(&$extra=array())
    {
        ...
        $search_fields = array_map('trim', explode(',', self::column_name('matter_type_name')));
