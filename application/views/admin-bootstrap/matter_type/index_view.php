...
<script type="text/x-kendo-template" id="matter_type-quickview-template">
    <div id="quickview-container">
        <table class="quickview-grid">
            ...
            <tbody>  
            	...
            	<tr>
                    <td><strong><?php _e('Matter Type Name'); ?></strong></td>
                    <td><?php echo kendouiDataItemTemplateString('matter_type_name'); ?></td>
             	</tr>
...
<script type="text/javascript">
    ...
    $(function() {
        grid(
            $('#matter_typeGrid'),
            {
                ...
                model : {
                    ...
                    fields: {
                        actions:{},
                        matter_type_name: { type: 'string' },
                        is_active: { type: 'number' }
                    }
                },
                gridOptions : {
                    toolbar: [{template:$('#matter_type-toolbar-template').html()}],
                    columns: [
                        {
                            title:'<?php _e('Actions') ?>',
                            template: $('#matter_type-actions-template').html(),
                            filterable:false,
                            groupable:false,
                            sortable:false,
                            width:150,
        ...
        matter_typeGrid = $('#matter_typeGrid').data('kendoGrid');
